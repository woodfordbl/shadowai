...
class MetadataUtil {
    ...
    parseManifest(manifest) {
        ...
        props[prefix + "staticTabs.contentUrl"] =
            (_g = (_f = manifest.staticTabs) === null || _f === void 0 ? void 0 : _f.map((tab) => tab.contentUrl
                ? crypto_1.createHash("sha256").update(tab.contentUrl).digest("base64")
                : "undefined").toString()) !== null && _g !== void 0 ? _g : "";
        props[prefix + "configurableTabs.configurationUrl"] =
            (_j = (_h = manifest.configurableTabs) === null || _h === void 0 ? void 0 : _h.map((tab) => tab.configurationUrl
                ? crypto_1.createHash("sha256").update(tab.configurationUrl).digest("base64")
                : "undefined").toString()) !== null && _j !== void 0 ? _j : "";
        props[prefix + "webApplicationInfo.id"] = (_l = (_k = manifest.webApplicationInfo) === null || _k === void 0 ? void 0 : _k.id) !== null && _l !== void 0 ? _l : "";
        (_m = globalVars_1.TOOLS.telemetryReporter) === null || _m === void 0 ? void 0 : _m.sendTelemetryEvent(telemetry_1.TelemetryEvent.MetaData, props);
    }
}
