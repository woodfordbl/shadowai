...
let ConfigureTeamsAppDriver = class ConfigureTeamsAppDriver {
    ...
    async update(args, context, outputEnvVarNames) {
        ...
        try {
            ...
            return teamsfx_api_1.err(results_1.AppStudioResultFactory.SystemError(errors_1.AppStudioError.TeamsAppUpdateFailedError.name, errors_1.AppStudioError.TeamsAppUpdateFailedError.message(teamsAppId), "https://aka.ms/teamsfx-actions/teamsapp-update"));
        }
    }
    validateArgs(args) {
        const invalidParams = [];
